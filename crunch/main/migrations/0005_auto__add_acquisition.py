...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('main_acquisition', (
            ...
            ('price_amount', self.gf('django.db.models.fields.IntegerField')(null=True)),
            ('price_currency_code', self.gf('django.db.models.fields.CharField')(max_length=10, null=True, blank=True)),
            ('term_code', self.gf('django.db.models.fields.CharField')(max_length=40, null=True, blank=True)),
            ...
            ('acquired_year', self.gf('django.db.models.fields.IntegerField')(null=True)),
            ('acquired_month', self.gf('django.db.models.fields.IntegerField')(null=True)),
            ('acquired_day', self.gf('django.db.models.fields.IntegerField')(null=True)),
            ('acquiring_company', self.gf('django.db.models.fields.related.ForeignKey')(related_name='acquisitions', null=True, to=orm['main.Company'])),
        ))
