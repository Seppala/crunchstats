...
class TestCompanyModel(TestCase):
	...
	def get_json_doesnt_exist(self):
		...
		name = j['name']
#Didn't work for some reason, took it away... 
	def by_tag_view(self):
...
class TestJsons(TestCase):
	...
	def test_fetching_and_saving_json(self):
		...
		#category_code
		self.assertEquals(only_company_in_database.category_code, "games_video")
		#number of employees
		...
		cuud = get_by_desc('lightweight')
		print('gotten by get_by_desc:')
		print(cuud)
